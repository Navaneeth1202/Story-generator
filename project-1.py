...
# List of places to vary locations
...
def thriller_structure(protagonist, partner, num_lines):
    ...
    while len(story) < num_lines:
        ...
        story.append(f"Their lives were now at risk, but they knew they had to find the truth.")
        story.append(f"Desperate for answers, they returned to the asylum, where a figure awaited them.")
        story.append(f"The figure revealed a shocking truth—someone close to them had orchestrated the disappearances.")
        story.append(f"With everything at stake, {protagonist} and {partner} had to make a life-or-death decision.")
    
    return story[:num_lines]

# Rom-Com structure (unchanged)
...
if __name__ == "__main__":
    ...
    print(story_result)  # Display the story properly without extra formatting issues
